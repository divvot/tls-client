...
func ja3_chrome_120(t *testing.T) {
	...
	specFunc, err := tls_client.GetSpecFactoryFromJa3String(input, ssa, dca, sv, sc, alpnProtocols, alpsProtocols, ccs, cp, ca, nil, 0)
...
func ja3_chrome_112_with_psk(t *testing.T) {
	...
	specFunc, err := tls_client.GetSpecFactoryFromJa3String(input, ssa, dca, sv, sc, alpnProtocols, alpsProtocols, nil, nil, ca, nil, 0)
